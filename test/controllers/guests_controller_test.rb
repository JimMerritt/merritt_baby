...
class GuestsControllerTest < ActionController::TestCase
  ...
  test "should create guest" do
    assert_difference('Guest.count') do
      post :create, guest: { boy: @guest.boy, girl: @guest.girl, message: @guest.message, name: @guest.name }
    end
  ...
  test "should update guest" do
    patch :update, id: @guest, guest: { boy: @guest.boy, girl: @guest.girl, message: @guest.message, name: @guest.name }
    assert_redirected_to guest_path(assigns(:guest))
  end
