...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { message: @voter.message, name: @voter.name, vote: @voter.vote }
    end
  ...
  test "should update voter" do
    patch :update, id: @voter, voter: { message: @voter.message, name: @voter.name, vote: @voter.vote }
    assert_redirected_to voter_path(assigns(:voter))
  end
